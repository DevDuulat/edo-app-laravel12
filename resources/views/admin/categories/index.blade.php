<x-layouts.app :title="__('Категории')">
    ...
    <div class="flex flex-col flex-1 w-full h-full gap-6">
        <div class="flex justify-between items-center">
            ...
            {{-- Кнопка для создания категории. Триггер модального окна Alpine --}}
            <div x-data @click="$dispatch('open-modal', { name: 'create-category' })">
                <button type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
